...
@Component({
  selector: 'app-insurance-app-survey-details',
  templateUrl: './insurance-app-survey-details.page.html',
  styleUrls: ['./insurance-app-survey-details.page.scss'],
})
export class InsuranceAppSurveyDetailsPage implements OnInit {
  fileId: any;
  file: any;
  files: any[] = [];
  public items: any = [];
      ...
      if (Object.keys(params).length != 0) {
        this.odooApi.callOdooMethod('survey.report', 'search_read',
          {filter: [['id', '=', Number(params['id'])]]}).then(res => {
            ...
            this.applicationNumber = this.surveyDetails['application_id'][1];
