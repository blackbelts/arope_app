...
@Component({
  selector: 'app-motor-claim-survey-details',
  templateUrl: './motor-claim-survey-details.page.html',
  styleUrls: ['./motor-claim-survey-details.page.scss'],
})
export class MotorClaimSurveyDetailsPage implements OnInit {
  fileId: any;
  file: any;
  files: any[] = [];
  public items: any = [];
